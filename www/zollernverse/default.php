...
<table class="table bordercolor pageContent" cellspacing="1" cellpadding="4">
  ...
  $r = explode("<br />",$news["news"]);
   echo "<tr><th class=\"titlebg\" colspan=\"6\">News Fader</th></tr><tr><td align=\"center\" class=\"mainbg2\" height=\"66\" colspan=\"6\" valign=\"center\"><div id=\"news\">";
    for($i=0;$i<count($r);$i++){
			...
			?>
				<?php
					...
					for($i=0;$i<sizeof($ct);$i++){
						...
						echo "<tr><th class=\"catbg\" colspan=\"5\"><a href=\"?act=viewcategory&id=".$ctgs["id"]."\" name=\"ctg".$ctgs["id"]."\">".stripslashes($ctgs["name"])."</a> &nbsp; &nbsp; <a href=\"javascript:;\" style=\"font-size:14px;font-family:'Verdana';\" onclick=\"toggleCategory(".$ctgs["id"].");\" id=\"sh".$ctgs["id"]."\">hide</a></th></tr><tr><td class=\"mainbg2\" colspan=\"5\"><font style=\"font-size:14px;\">".ubbc($ctgs["about"])."</font>";
