...
//XSP Code
$xsp->Parse("set var name = \"John\"");
$xsp->Parse("print var:name");
?>

Documentation is included within a text file in this package, as well as a beginner's guide.
...
-- Paul T. Shannon Jr. a.k.a Alpha Wolf